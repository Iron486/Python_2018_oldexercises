...
[equation.py](https://github.com/Iron486/Python_2018_oldexercises/blob/main/equation.py) represents in the Cartesian plane a maximum of 2 mathematical functions given as input.
...
[Rubik.py](https://github.com/Iron486/Python_2018_oldexercises/blob/main/Rubik.py) that generates a random scramble for the Rubik's cube and some other teasers, with a Tkinter interface; and calculates the time that it takes to solve the puzzle along with some statistical parameters.
